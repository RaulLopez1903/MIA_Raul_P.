...
- **Environment:**  Mercado de valores en linea, con acciones de precios cambiantes e incertidumbre del futuro, wallet del usuario (estocástico).
...
- **Performance:**  Velocidad, dianosticos acertados, maximizar alcance de inspección, menor consumo de energía, estabilidad.
...
- **Actuators:**  Aspas, bocina para sonidos de recuperación, envio de informes en tiempo real.
- **Sensors:**  Cámara, sensor de calor, escaner, GPS.
