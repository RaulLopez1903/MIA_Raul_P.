...
## 1. Instancia elegida y gráfico de la ciudad

Para este análisis se seleccionó la ruta con origen en ``Timisoara`` y destino en ``Bucharest``. 

### Gráfico de la ciudad de Rumania (Distancias en km)
...
2. **Búsqueda con costo uniforme (UCS):**
...
4. **Búsqueda a lo ancho con límite 2 (DLS):**
...
5. **Búsqueda a lo ancho con límite 4 (DLS):**
